...
namespace StartGrow.Controllers
{
    public class ProyectoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProyectoId,Nombre,MinInversion,Plazo,Interes,Importe,Progreso,NumInversores,FechaExpiracion")] Proyecto proyecto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProyectoId,Nombre,MinInversion,Plazo,Interes,Importe,Progreso,NumInversores,FechaExpiracion")] Proyecto proyecto)
        {
